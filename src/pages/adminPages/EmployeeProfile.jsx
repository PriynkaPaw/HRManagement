...
function EmployeeProfile() {
  ...
  <a href="#">
    ...
    <h3 class="user-name m-t-0 mb-0">{EmployeeDetails?.first_name}</h3>
    <h6 class="text-muted">{EmployeeDetails?.department} </h6>
    <small class="text-muted">{EmployeeDetails?.designation} </small>
    <div class="staff-id">Employee ID : FT-0001</div>
    <div class="small doj text-muted">Date of Join :{EmployeeDetails?.date_of_joining}</div>
    ...
    <div class="text"><a href="#">{EmployeeDetails?.phone}</a></div>
    </li>
    <li>
    <div class="title">Email:</div>
    <div class="text"><a href="#"><span class="__cf_email__" data-cfemail="2b414443454f444e6b4e534a465b474e05484446"> </span>{EmployeeDetails?.email}</a></div>
       {/* //[email&#160;protected] */}
    </li>
    <li>
    
    <div class="title">Birthday:</div>
    <div class="text"> {EmployeeDetails?.date_of_birth} </div>
    </li>
    <li>
    <div class="title">Address:</div>
    <div class="text">{EmployeeDetails?.address} </div>
    </li>
    <li>
    ...
    <p><span class="__cf_email__" data-cfemail="9df7f2f5f3ddf9eff8fcf0fae8e4eee9f8fef5b3fef2f0">[email&#160;protected]</span></p>
    </a>
    </td>
    <td>
    ...
    <p><span class="__cf_email__" data-cfemail="ec9a85828388c29fac889e898d818b99959f98898f84c28f8381">[email&#160;protected]</span></p>
    </a>
    </td>
    <td>
    <div class="table-actions d-flex">
    ...
    <a href="javascript:void(0);" class="table-name">
    <span>Harika </span>
    <p><span class="__cf_email__" data-cfemail="3d555c4f54565c134b7d594f585c505a48444e49585e55135e5250">[email&#160;protected]</span></p>
    </a>
    </td>
    <td>
    <div class="table-actions d-flex">
    ...
    <span>Mythili</span>
    <p><span class="__cf_email__" data-cfemail="a8c5d1dcc0c1c4c1e8ccdacdc9c5cfddd1dbdccdcbc086cbc7c5">[email&#160;protected]</span></p>
    </a>
    </td>
    <td>
    <div class="table-actions d-flex">
    ...
    <a href="assets-details.html" class="table-name">
    <span>John Paul Raj</span>
    <p><span class="__cf_email__" data-cfemail="751f1a1d1b35110710141812000c060110161d5b161a18">[email&#160;protected]</span></p>
    </a>
    </td>
    <td>
    <div class="table-actions d-flex">
    ...
    <a href="javascript:void(0);" class="table-name">
    <span>Vinod Selvaraj</span>
    <p><span class="__cf_email__" data-cfemail="aadcc3c4c5ce84d9eaced8cfcbc7cddfd3d9decfc9c284c9c5c7">[email&#160;protected]</span></p>
    </a>
    </td>
    <td>
    <div class="table-actions d-flex">
